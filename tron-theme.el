...
(custom-theme-set-faces
 ...
 `(font-lock-function-name-face ((t (:foreground "SteelBlue3"))))
 ...
 `(font-lock-variable-name-face ((t (:foreground "SteelBlue2"))))
 `(minibuffer-prompt ((t (:foreground "#729fcf" :bold t))))
 `(font-lock-warning-face ((t (:foreground "red" :bold t))))
 `(org-document-title ((t (:inherit font-lock-function-name-face :height 1.2))))
 ...
 '(org-checkbox-statistics-todo ((t (:inherit org-checkbox))))
 '(org-date ((t (:inherit org-special-keyword))))
 '(org-done ((t (:foreground "gray70" :height 0.7 :slant italic))))
 '(org-headline-done ((t (:foreground "gray50" :slant italic))))
 '(org-special-keyword ((t (:inherit font-lock-comment-face :height 0.9))))
 '(org-todo ((t (:overline "SteelBlue1" :underline "SteelBlue1" :weight bold))))
)
